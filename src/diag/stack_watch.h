 ...
 *
 * Build-flag gated via OPENEVCHARGER_STACK_WATCH. When the flag is 0 (default
...
#ifndef OPENEVCHARGER_DIAG_STACK_WATCH_H
#define OPENEVCHARGER_DIAG_STACK_WATCH_H

#include "FreeRTOS.h"
#include "task.h"

#ifndef OPENEVCHARGER_STACK_WATCH
#define OPENEVCHARGER_STACK_WATCH 0
#endif
