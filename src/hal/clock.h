#ifndef OPENEVCHARGER_HAL_CLOCK_H
#define OPENEVCHARGER_HAL_CLOCK_H
 ...
 *
 * Gated on build flag OPENEVCHARGER_REAL_120M_PLL — when 0, this is a
 ...
 * a failure stage. No-op when OPENEVCHARGER_REAL_120M_PLL=0. */
